...
import { ListChecks, Loader2, RotateCcw, Search, X } from "lucide-react";
...
import type { ReportJobSummary } from "@/lib/report-grading";
  ...
  const searchBox = (
    <div className="relative w-full sm:max-w-xs">
      ...
      <Input
        ...
        className="pl-8 pr-8"
        aria-label="Search by report title or author name"
      />
      {search ? (
        <button
          type="button"
